...
def nombrArray(array)
  puts "#{array.length}"
end

def plusPetit(array)
  plusCourtName=array[0]
  array.each do |name|
    if name.length<plusCourtName.length
      plusCourtName=name
    end
  end
  puts plusCourtName
...
# def tailPlusGrand (array)
#   plusLongName=""
#   array.each do |name|
#     if name.length>plusLongName.length
#     plusLongName=name
#     end
#   end
#   puts plusLongName.length  
# end

def quantite5F(array)
  quantite5=0
  array.each do |name|
    if name.length==6
      quantite5+=1
...
def quantitMajusculeF(array)
  ...
  puts quantitMajuscule
end

def trierAlphabetique(array)
  array=array.sort
  puts array
end

def trierTaille(array)
  array=array.sort_by { |name| name.length }
  puts array
end
...
def classement(array)
  # les classer
  # pour taille -1
  # comparer tail n et n+1
  # si identiquer nom+=1
  # si diferent il y a nombre de cette tail et nombre=1
  array=array.sort_by { |name| name.length }
  quantite=1
...
def menu(array)
  ...
  if choi==1
    ...
    quantitMajusculeF(array)
  elsif choi==5
    trierAlphabetique(array)
  elsif choi==6
    trierTaille(array)
  elsif choi==7
    position(array)
